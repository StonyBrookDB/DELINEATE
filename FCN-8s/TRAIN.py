...
Train_Image_Dir="Data_Zoo/Steatosis_Datasets/Train_Image/" # Images and labels for training
Train_Label_Dir="Data_Zoo/Steatosis_Datasets/Train_Label/"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=True# do you want to use validation set in training
Valid_Image_Dir="Data_Zoo/Steatosis_Datasets/Val_Image/"# Validation images that will be used to evaluate training
Valid_Labels_Dir="Data_Zoo/Steatosis_Datasets/Train_Label/"#  (the  Labels are in same folder as the training set)
...
learning_rate= 1e-5  #5 #Learning rate for Adam Optimizer
...
MAX_ITERATION = int(100010)  #80000)    #50000)  #100010) # Max  number of training iteration
